# language: pt
Funcionalidade: Validação da Tela Principal do PJe
  ...
  Cenário: Validar exibição de títulos na tela principal
    Então deve exibir o título "Processo Judicial Eletrônico"
    E deve exibir o subtítulo "Processo Judicial Eletrônico 1º Grau"
    E deve exibir "Poder Judiciário de Pernambuco"

  Cenário: Validar exibição de links de acesso
  ...
  Cenário: Validar disponibilidade de opção de recuperação de senha
