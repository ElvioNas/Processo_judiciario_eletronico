...
time.sleep(2)
driver.find_element(By.PARTIAL_LINK_TEXT, "Cadastro de sessão de julgamento")
time.sleep(2)
driver.find_element(By.PARTIAL_LINK_TEXT, "Pauta de audiência")
time.sleep(2)
driver.find_element(By.PARTIAL_LINK_TEXT, "Pendências da sessão de julgamento")
time.sleep(2)
driver.find_element(By.PARTIAL_LINK_TEXT, "Processo pautados em sessão")
time.sleep(2)
driver.find_element(By.PARTIAL_LINK_TEXT, "Relação de julgamento")
